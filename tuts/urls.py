...
urlpatterns = [
    ...
    url(r'^uc/$', views.uc),
    url(r'^news-single/$', courses_views.news_single),
    url(r'^gk-single/$', courses_views.gk_single),
    url(r'^blog-single/$', courses_views.blog_single),
    ...
    url(r'^news/$', courses_views.news),
    url(r'^blog/$', courses_views.blog),
